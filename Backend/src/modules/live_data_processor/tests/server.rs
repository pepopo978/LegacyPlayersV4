...
fn parse_spell_damage() {
    ...
    let messages = vec![
        Message {
            ...
            message_type: MessageType::InstanceMap(InstanceMap {
                ...
                map_difficulty: 0,
                unit: Unit { is_player: false, unit_id: caster_unit_id, is_self_damage: false, is_mind_control: false },
            }),
        },
        Message {
            message_count: 1,
            ...
            message_type: MessageType::InstanceMap(InstanceMap {
                ...
                instance_id: caster_instance_id,
                map_difficulty: 0,
                unit: Unit { is_player: false, unit_id: target_unit_id, is_self_damage: false, is_mind_control: false },
            }),
        },
        Message {
            message_count: 2,
        ...
        Message {
            ...
            message_type: MessageType::SpellDamage(DamageDone {
                attacker: Unit { is_player: false, unit_id: caster_unit_id, is_self_damage: false, is_mind_control: false },
                victim: Unit { is_player: false, unit_id: target_unit_id, is_self_damage: false, is_mind_control: false },
                spell_id: Some(26),
                hit_mask: 1,
                blocked: 1,
    ...
    let messages = vec![Message {
        ...
        message_type: MessageType::SpellCast(SpellCast {
            caster: Unit { is_player: false, unit_id: caster_unit_id, is_self_damage: false, is_mind_control: false },
            target: Some(Unit { is_player: false, unit_id: target_unit_id, is_self_damage: false, is_mind_control: false }),
            spell_id: 26,
            hit_mask: 7,
        }),
    }];
    ...
    let messages = vec![Message {
        ...
        timestamp: 75,
        message_type: MessageType::SpellCast(SpellCast {
            caster: Unit { is_player: false, unit_id: target_unit_id, is_self_damage: false, is_mind_control: false },
            target: Some(Unit {
                is_player: false,
