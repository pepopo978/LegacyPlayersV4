...
import {ChartDataset, ChartOptions, ChartType, ChartData, Color} from 'chart.js';
...
import {chart_type_to_number, ChartType as ChartTypeValue, number_to_chart_type} from "../../domain_value/chart_type";
    ...
    constructor(
        ...
        for (const sample_data_set of [DataSet.Deaths, DataSet.Kills, DataSet.DispelsDone, DataSet.InterruptDone, DataSet.SpellStealDone]) {
            this.chartDatasets.push({
                ...
                type: is_event_data_set(sample_data_set) ? "scatter" : number_to_chart_type(this.selected_chart_type) as ChartType,
                    ...
                    if (this.selected_chart_type === 1) {
                        ...
                        for (const [ability_id, dmg_arr] of result.slice(0, 5)) {
                            ...
                            this.chartDatasets.push({
                                ...
                                type: ChartTypeValue.Bar as ChartType,
